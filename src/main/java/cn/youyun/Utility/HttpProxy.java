...
public class HttpProxy {
    ...
    public static String HttpPost(String params, String requestUrl) throws IOException {
        ...
        postMethod.setRequestHeader("Content-length", String.valueOf(requestBytes.length));
        System.out.println("请求参数长度:" + String.valueOf(requestBytes.length));

        InputStream inputStream = new ByteArrayInputStream(requestBytes, 0, requestBytes.length);

        RequestEntity requestEntity = new InputStreamRequestEntity(inputStream, requestBytes.length, "application/x-www-form-urlencoded; charset=utf-8"); // 请求体
        ...
        else System.out.println("响应参数：" + result);

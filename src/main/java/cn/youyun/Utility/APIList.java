...
public class APIList {
     ...
     * @return success,Msg,ReObj
     */
    public String UnifiedOrder(String DockingDeviceID,String DeviceID,String devicesecret,String timestamp,String nonceStr,String OrderID,int SiteUserID, String Paytype, BigDecimal Paymoney,String DockingSecret){
        //wap收款请求地址
        String postfix = "/api/UnifiedOrder/";
        String RequestURL = ApiDomain + postfix;
        //wap收款签名逻辑
        String stringA ="DeviceID="+DeviceID+"&devicesecret="+devicesecret+"&DockingDeviceID="+DockingDeviceID+"&OrderID="+OrderID+"&nonceStr="+nonceStr+"&Paymoney="+Paymoney+"&Paytype="+Paytype+"&SiteUserID="+SiteUserID+"&timestamp="+timestamp;//ascii序
        String sign = DataUtil.GetSign(stringA,DockingSecret);
        //请求响应
        String RequestStr ="deviceid="+DeviceID+"&devicesecret="+devicesecret+"&DockingDeviceID="+DockingDeviceID+"&OrderID="+OrderID+"&nonceStr="+nonceStr+"&Paymoney="+Paymoney+"&Paytype="+Paytype+"&SiteUserID="+SiteUserID+"&timestamp="+timestamp+"&sign="+sign;
        String result = Post4Pay.HttpPost(RequestStr,RequestURL);
        return result;
    }
